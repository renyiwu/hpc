...
/* # To activate the following two lines, keep two leading slashes; otherwise keep one one.

params.reads = "/scratch/rw409/fastq/tramp-methyl/test/*_R{1,2}_001.fastq.gz"
